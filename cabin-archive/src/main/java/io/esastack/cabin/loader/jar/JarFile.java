...
import io.esastack.cabin.loader.data.RandomAccessDataFile;
...
public class JarFile extends java.util.jar.JarFile {
    ...
    //this is a prefix, Handler name is : prefix + protocol + 'Handler', where protocol is jar
    private static final String CABIN_HANDLER_PACKAGE = "io.esastack.cabin.loader";
    ...
    public static void registerUrlProtocolHandler() {
        ...
        System.setProperty(PROTOCOL_HANDLER, ("".equals(handlers) ? CABIN_HANDLER_PACKAGE
                : handlers + "|" + CABIN_HANDLER_PACKAGE));
